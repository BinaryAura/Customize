...
public class testGUI extends GuiIngame
{
    ...
    public static boolean renderHelmet = true;       // Not Needed
    public static boolean renderPortal = true;       // Not Needed
    public static boolean renderHotbar = true;       // Needed
    public static boolean renderCrosshairs = true;   // Needed
    public static boolean renderBossHealth = true;   // Needed
    public static boolean renderHealth = true;       // Needed
    public static boolean renderArmor = true;        // Needed
    public static boolean renderFood = true;         // Needed
    public static boolean renderHealthMount = true;  // Needed
    public static boolean renderAir = true;          // Needed
    public static boolean renderExperiance = true;   // Needed
    public static boolean renderJumpBar = true;      // Needed
    public static boolean renderObjective = true;	 // Needed
    
    // Missing Flags
    
    public static boolean renderVignette = true;     // Not Needed
    public static boolean renderTooltip = true;      // Needed
    public static boolean renderDebug = true;        // Needed
    public static boolean renderRecord = true;       // Needed
    public static boolean renderTitle = true;        // Needed
    public static boolean renderChat = true;         // Not Needed
    public static boolean renderPlayerList = true;   // Needed
    ...
    @Override
    public void renderGameOverlay(float partialTicks)  // Look at onPostClientTick
    {
        ...
        renderSleepFade(width, height);    //  <--- Change?
        ...
        renderToolHightlight(res);  // Tooltip    <--- Change
        renderHUDText(width, height);  // Debug     <--- Change
        renderRecordOverlay(width, height, partialTicks);  // Record Tooltip    <--- Change
        renderTitle(width, height, partialTicks);  //Title		<--- Change?
        ...
        if (renderObjective && scoreobjective1 != null)  // Good
        {
        ...
        renderChat(width, height);   // <--- This is Fine

        renderPlayerList(width, height);    // <--- Change
