...
###Installation
  ...
  To install this mod, first you must run the minecraft listed, to do this click "New Profile" or "Edit Profile". In "Use version" Click on the minecraft version listed then, "Save Profile". Click "Play". This will download the version you need to install Forge. Now, run the install program for forge and install for client. Move the customizexxx-x.jar to the mods directory in the .minecraft file in %AppData%. 
